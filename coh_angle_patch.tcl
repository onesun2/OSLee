...
set out [open oh_dihedral.out w]
set out2 [open oh_angle.out w]
for {set i 0} {$i < [$hh num]} {incr i} {
	...
	if {[llength $list4] == 2} {
		...
		topo adddihedral $idx1 $idx2 $idx3 $idx40
		topo adddihedral $idx1 $idx2 $idx3 $idx41
		puts $out2 "angle1 $idx2 $idx3 $idx40"
		puts $out2 "angle2 $idx2 $idx3 $idx41"
		topo addangle $idx2 $idx3 $idx40
		topo addangle $idx2 $idx3 $idx41
		...
		topo adddihedral $idx1 $idx2 $idx3 $idx40
		topo adddihedral $idx1 $idx2 $idx3 $idx41
		topo adddihedral $idx1 $idx2 $idx3 $idx42
		puts $out2 "angle1 $idx2 $idx3 $idx40"
		puts $out2 "angle2 $idx2 $idx3 $idx41"
		puts $out2 "angle3 $idx2 $idx3 $idx42"
		topo addangle $idx2 $idx3 $idx40
		topo addangle $idx2 $idx3 $idx41
		topo addangle $idx2 $idx3 $idx42
	}
}
close $out
close $out2
